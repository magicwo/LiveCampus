...
public class ImageGridActivity extends ImageBaseActivity implements ImageDataSource.OnImagesLoadedListener, ImageGridAdapter.OnImageItemClickListener, ImagePicker.OnImageSelectedListener, View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.btn_ok) {
            ...
            intent.putExtra(ImagePicker.EXTRA_IMAGE_TYPE, ImagePicker.IMAGE_TYPE_SELECT);
    ...
    public void onImageItemClick(View view, ImageItem imageItem, int position) {
        ...
        if (imagePicker.isMultiMode()) {
            ...
            intent.putExtra(ImagePicker.EXTRA_IMAGE_TYPE, ImagePicker.IMAGE_TYPE_FOLDER);
            intent.putExtra(ImagePreviewActivity.ISORIGIN, isOrigin);
    ...
    public void onImageSelected(int position, ImageItem item, boolean isAdd) {
        if (imagePicker.getSelectImageCount() > 0) {
            mBtnOk.setText(getString(R.string.select_complete, String.valueOf(imagePicker.getSelectImageCount())));
