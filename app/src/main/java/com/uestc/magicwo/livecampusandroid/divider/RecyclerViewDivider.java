package com.uestc.magicwo.livecampusandroid.divider;

/**
 * Created by Magicwo on 2017/1/23.
 * 万能分割线
 */
...
public class RecyclerViewDivider extends RecyclerView.ItemDecoration {
     ...
     */
    public RecyclerViewDivider(int mDividerHeight, Context context, int orientation) {
    ...
    public RecyclerViewDivider(Context context, int orientation, int dividerHeight, int dividerColor) {
        this(dividerHeight,context, orientation);
